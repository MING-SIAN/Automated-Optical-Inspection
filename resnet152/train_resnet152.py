...
#由於resnet152的fc有1000個，而我們可以固定的比例分割
...
for epoch in range(1, n_epochs+1):
    ...
    torch.save(model.state_dict(), 'C:/Users/ucl/Desktop/AIdeal_competition/train_resnet152/model/epoch%d-train_loss%.4f-val_loss%.4f-validation accuracy%.4f.pth' %(epoch, train_loss, valid_loss, accuracy))
...
plt.legend(loc='best')
plt.savefig('C:\\Users\\ucl\\Desktop\\AIdeal_competition\\train_resnet152\\figure\\Loss.jpg')
plt.show()